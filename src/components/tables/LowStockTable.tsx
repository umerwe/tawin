...
const LowStockTable = ({ data, activeTab }: LowStockTableProps) => {
    ...
    // Columns keys matching your translation file: no, product, category, amount, supplierName, operations
        ...
        <>
            ...
            <TableCell>
                <div className="flex items-center gap-3">
                    <div className="h-10 w-10 relative rounded border overflow-hidden bg-gray-50">
