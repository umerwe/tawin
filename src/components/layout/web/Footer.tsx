                ...
                <div>
                    <div className="flex flex-col md:flex-row md:justify-between items-start gap-12 mb-16 mx-auto max-w-7xl px-4 md:px-12">
                        ...
                        <div className="space-y-4 md:w-1/3">
                            ...
                            <div className="flex items-center gap-4 pt-2">
                                <Link href={settings?.socialLinks?.youtube || "#"} className="text-[#00C1C1] hover:opacity-80 transition-opacity">
                                    <Youtube size={20} />
                                </Link>
                                <Link href={settings?.socialLinks?.facebook || "#"} className="text-[#00C1C1] hover:opacity-80 transition-opacity">
                                    <Facebook size={20} />
                                </Link>
                                <Link href={settings?.socialLinks?.instagram || "#"} className="text-[#00C1C1] hover:opacity-80 transition-opacity">
                                    <Instagram size={20} />
                                </Link>
                                <Link href={whatsappLink} target="_blank" className="text-[#00C1C1] hover:opacity-80 transition-opacity">
                    ...
                    <div className="flex flex-col md:flex-row justify-center items-center gap-4 text-[11px] text-gray-400 mx-auto max-w-7xl px-8">
                        ...
                        <div className="flex items-center gap-4">
                            <Link href="/privacyPolicy" className="hover:underline transition-all">
                                {t("privacyPolicy")}
                            </Link>
                            <Link href="/termsAndConditions" className="hover:underline transition-all">
            ...
            <div className="mx-auto max-w-7xl px-8 py-6">
                <div className="flex flex-col-reverse items-start justify-between gap-8 sm:flex-row sm:items-center">
                    ...
                    <div className="flex items-center gap-6">
                        <Link href={settings?.socialLinks?.instagram || "#"} className="hover:opacity-80 transition-opacity">
                            <Instagram className="h-4 w-4" />
                        </Link>
                        <Link href={settings?.socialLinks?.facebook || "#"} className="hover:opacity-80 transition-opacity">
                            <Facebook className="h-4 w-4" />
                        </Link>
                        <Link href={settings?.socialLinks?.youtube || "#"} className="hover:opacity-80 transition-opacity">
                            <Youtube className="h-4 w-4" />
                        </Link>
                        <Link href={whatsappLink} target="_blank" className="hover:opacity-80 transition-opacity">
