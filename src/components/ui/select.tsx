    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          ...
          position === "popper" &&
            "data-[side=bottom]:translate-y-1 data-[side=left]:-translate-x-1 data-[side=right]:translate-x-1 data-[side=top]:-translate-y-1 rtl:text-right text-left",
          className
        )}
        position={position}
        align={align}
...
function SelectLabel({
  ...
  return (
    <SelectPrimitive.Label
      ...
      className={cn("text-muted-foreground px-2 py-1.5 text-xs rtl:text-right ltr:text-left", className)}
      {...props}
    />
  )
}
